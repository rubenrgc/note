...
function computeKeyObject(response, specifier, aliasMap) {
    ...
    specifier.forEach(function (s) {
        if (Array.isArray(s)) {
            ...
            process.env.NODE_ENV === "production" ? invariant__default(hasOwn$1.call(response, responseName), 40) : invariant__default(hasOwn$1.call(response, responseName), "Missing field " + responseName + " while computing key fields");
